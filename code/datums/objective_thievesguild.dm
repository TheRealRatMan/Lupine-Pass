...
/datum/objective/thieves_guild_objective/proc/setup_assassinate_objective()
    ...
    valid_roles = list("Grand Duke", "Prince", "Priest", "Priestess", "Councillor", "Acolyte", "Inquisitor", "Merchant", "Town Elder", TITLE_HAMLET_SMITH, "Steward", "Clerk")
    var/list/strong_combat_roles
    strong_combat_roles = list("Knight", "Marshal", "Knight Captain", "Man at Arms", "Sergeant", "Warden", "Watchman", "Squire", "Dungeoneer", TITLE_SAILOR, TITLE_BURGMEISTER)
    var/list/candidates
    candidates = list()
